  ...
  return (
    ...
    >
      <path
        ...
        fill="var(--m5zs3g, var(--token-9913619f-76ec-4fff-b5d9-aef25028820c, rgb(254, 246, 42)))"
        height="35px"
        id="WHbkZu4LB"
        width="35px"
      ></path>
      <path
        ...
        fill="var(--b5lzrg, var(--token-04d93255-d6ab-4bbc-a194-71e004214fb0, rgb(12, 16, 18)))"
        height="9px"
        id="mGV8bx2Ew"
