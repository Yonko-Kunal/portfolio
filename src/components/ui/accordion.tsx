...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex cursor-pointer items-center hover:bg-black/5 dark:hover:bg-white/5">
      ...
      >
        {children}
        <ChevronDownIcon className="text-muted-foreground pointer-events-none mr-2 size-4 shrink-0 translate-y-0.5 transition-transform duration-400" />
      </AccordionPrimitive.Trigger>
