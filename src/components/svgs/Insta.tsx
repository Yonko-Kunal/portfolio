...
// I added a default size (w-8 h-8) but you can override it with className
export default function Insta({
  className = "w-12 h-12",
}: {
  className?: string;
}) {
  // We generate unique IDs to prevent iOS conflicts
  const gradId1 = "insta-grad-a";
  const gradId2 = "insta-grad-b";
  ...
  return (
    <svg
      ...
      xmlSpace="preserve"
      viewBox="0 0 512 512"
      // Combine your default classes with the passed className
