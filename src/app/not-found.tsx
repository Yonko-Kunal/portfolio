        ...
        <Container>
            <div className='flex md:flex-row flex-col items-center justify-center h-[80vh] '>
                ...
                <div className='flex flex-col items-center justify-center md:w-full w-[20rem]'>
                    ...
                    <p className='text-[15px]/7 text-neutral-400'>cause this page doesn't exist <Link href={"/"}><span className='text-yellow-500 underline hover:text-yellow-600 hover:text-[15px]'>Let's go home</span ></Link></p>
                </div>
            </div>
